  ...
  <body>
	...
	<?php
		...
		if(isset($_GET['loginemailnotexist'])){
			echo '<div class="alert alert-danger">Sorry ! dear your account email is not exist</div>';
		}
	?>
	...
	<?php
	 echo'
		<div class="container form-container">
			...
			<form method="POST" action="partials/handlelogin.php">
				<div class="form-group">
					<label for="ownerEmailAddress">Email Address</label>
					<input class="form-control" type="text" id="ownerEmailAddress" name="loginOwnerEmailAddress" required>
				</div>

				<div class="form-group">
					<label for="ownerPassword">Password</label>
					<input type="password" class="form-control" type="text" id="ownerPassword" name="loginOwnerPassword" required>
				</div>

				<div class="form-group">
					<div class="row">
						<div class="col-md-4 col-sm-12 d-grid my-2">
							<button type="submit" class="btn btn-primary py-2">Log in</button>
						</div>
						<div class="col-md-8 col-sm-12 d-grid my-2">
